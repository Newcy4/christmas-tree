...
const Experience = ({
  ...
  return (
    <>
      ...
      <color attach="background" args={["#0e3f2d"]} />
      <Stars
        radius={100}
        depth={50}
        count={5000}
      ...
      <EffectComposer>
        <Bloom
          ...
          mipmapBlur
        />
        <Vignette eskil={false} offset={0.5} darkness={0.25} opacity={0.35} />
      </EffectComposer>
    </>
  );
};
    ...
    >
      ...
      >
        ...
        >
          <ChristmasTitle
            title="阿绿 & 阿四"
            subtitle="YIER ❤️ BUBU · Merry Christmas · 2025"
          />
        </div>
      </div>
